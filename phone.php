  ...
  <div id="logoR">
    ...
    <nav id="nav">
      <ul>
        ...
        <li  class="active"><a href="phone.php">手機總覽</a></li>
...
<ul class="test_tour">
  <li class="tour_list"><a class="DB" href="#">品牌 <i class="fa fa-caret-down" aria-hidden="true"></i></a></li>
...
<ul class="test_tour">
  <li class="tour_list"><a class="DB" href="#">尺寸 <i class="fa fa-caret-down" aria-hidden="true"></i></a></li>
  <li class="tour_category"><a class="DB " href="#">4'-5'</a></li>
  <li class="tour_category"><a class="DB " href="#">5'-5.5'</a></li>
  <li class="tour_category"><a class="DB " href="#">5.5-6'</a></li>
  <li class="tour_category"><a class="DB " href="#">其他尺寸</a></li>
</ul>

<ul class="test_tour">
  <li class="tour_list"><a class="DB" href="#">價格 <i class="fa fa-caret-down" aria-hidden="true"></i></a></li>
  <li class="tour_category"><a class="DB " href="#">5,000　↓</a></li>
  <li class="tour_category"><a class="DB " href="#">5,000~10,000</a></li>
  <li class="tour_category"><a class="DB " href="#">10,000~15,000</a></li>
  <li class="tour_category"><a class="DB " href="#">15,000~20,000</a></li>
  <li class="tour_category"><a class="DB " href="#">20,000 ↑</a></li>
</ul>

<ul class="test_tour">
  <li class="tour_list"><a class="DB" href="#">功能 <i class="fa fa-caret-down" aria-hidden="true"></i></a></li>
  <li class="tour_category"><a class="DB " href="#">防水,防塵</a></li>
  <li class="tour_category"><a class="DB " href="#">4K錄影</a></li>
  <li class="tour_category"><a class="DB " href="#">雙卡雙待</a></li>
  <li class="tour_category"><a class="DB " href="#">4G/3G</a></li>
  <li class="tour_category"><a class="DB " href="#">雙卡雙待</a></li>
</ul>
